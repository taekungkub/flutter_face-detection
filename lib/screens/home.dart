...
import 'package:flutter_test_version/screens/face_detector_view.dart';

class Home extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Google ML Kit Demo App'), centerTitle: true, elevation: 0),
      body: SafeArea(
        child: Center(
              ...
              child: Column(
                children: [
                  ExpansionTile(
                    ...
                    children: [CustomCard('Face Detection', FaceDetectorView())],
                  ),
                ],
              ),
            ),
