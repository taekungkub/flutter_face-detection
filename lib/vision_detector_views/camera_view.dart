...
class _CameraViewState extends State<CameraView> {
  ...
  void initState() {
    ...
    throttler = Throttler(milliSeconds: 2000);
  }
  ...
  InputImage? _inputImageFromCameraImage(CameraImage image) {
    ...
    // Handle YUV format (format 35 is YUV_420_888)
    if (Platform.isAndroid && image.format.raw == 35) {
      // For YUV format, we need to handle all three planes
      ...
      return InputImage.fromBytes(
        ...
        metadata: InputImageMetadata(
          ...
          rotation: rotation,
          format: InputImageFormat.nv21, // Treat as NV21 for ML Kit
          bytesPerRow: image.width,
        ),
      );
    }

    // Original code for handling NV21 or BGRA8888
